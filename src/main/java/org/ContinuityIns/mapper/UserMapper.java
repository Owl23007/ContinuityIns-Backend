...
public interface UserMapper {
        ...
        void updateStatus(@Param("id") Integer id,
                        @Param("status") UserPO.UserStatus status);
        ...
        void updateLastLogin(@Param("userId") Integer userId, @Param("lastLogin") java.util.Date lastLogin,
                        @Param("ip") String ip);
        ...
        UserPO getUserWithSettingsById(@Param("userId") Integer userId);
